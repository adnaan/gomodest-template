...
func (f TodoFunc) Mutate(ctx context.Context, m models.Mutation) (models.Value, error) {
	mv, ok := m.(*models.TodoMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *models.TodoMutation", m)
	}
	return f(ctx, mv)
}
